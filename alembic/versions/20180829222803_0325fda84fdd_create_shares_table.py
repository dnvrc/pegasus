...
def upgrade():
        op.get_bind().execute(
            ...
            CREATE TABLE `shares` (
                ...
                `network_hashrate` bigint DEFAULT NULL,
                `price_usd` float(2) DEFAULT NULL,
                `price_btc` float(12) DEFAULT NULL,
                `sent_in_usd` integer DEFAULT NULL,
                `sent_by_address` integer DEFAULT NULL,
                `marketcap` integer DEFAULT NULL,
